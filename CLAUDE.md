...
- ✅ 导出为 Excel 文件
  - 工作表1：记录明细
  - 工作表2：统计汇总
- ✅ 自动文件命名：租金记录_YYYY-MM-DD.xlsx

#### 6. 邮件系统
**邮件配置**
- ✅ SMTP 服务器设置（支持 QQ/Gmail/163 等）
- ✅ 邮件配置测试
- ✅ 发件人信息配置
...
#### 7. 定时任务（Cron Jobs）
- ✅ 每日任务（UTC 00:00 / 北京时间 08:00）
  - 检查付款提醒
  - 检查逾期提醒
- ✅ 月度任务（每月1号 UTC 01:00 / 北京时间 09:00）
  - 自动发送上月账单

#### 8. 安全特性
- ✅ bcrypt 密码加密
- ✅ JWT 会话管理（7天有效期）
- ✅ 路由保护（middleware + layout 双重验证）
- ✅ Cron 任务鉴权（CRON_SECRET）
